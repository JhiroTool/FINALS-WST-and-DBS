...
<html>
<head>
    <title>Edit Amenity Promo</title>
        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-header bg-warning text-white text-center">
                    <h2 class="mb-0"><i class="bi bi-pencil-square"></i> Edit Amenity Promo</h2>
                </div>
                <div class="card-body">
                    <?= $message ?>
                    <form method="post">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="admin_homepage.php#amenity-promos" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
                        </div>
                    </form>
                </div>
            </div>
