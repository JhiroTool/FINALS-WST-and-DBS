...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($db->addAmenityPromo($amenity_id, $price, $from, $to)) {
...
<html>
<head>
    <title>Add Amenity Promo</title>
    <link rel="stylesheet" href="./bootstrap-5.3.3-dist/css/bootstrap.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css">
    <link rel="stylesheet" href="assets/css/amenity_promo.css">
</head>
<body>
<div class="promo-glass-card card shadow">
    <div class="card-header text-center">
        <h2><i class="bi bi-tag"></i> Add Amenity Promo</h2>
    </div>
    <div class="card-body">
        <?= $message ?>
        <form method="post">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="admin_homepage.php#amenities" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
            </div>
        </form>
    </div>
</div>
